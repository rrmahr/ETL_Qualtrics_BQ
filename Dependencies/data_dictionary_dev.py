...
#Open data extracted from API
open_file = open('Dependencies/data.pkl', "rb")
data = pickle.load(open_file)
open_file.close()

open_file = open('Dependencies/responses_df.pkl', "rb")
df = pickle.load(open_file)
open_file.close()


#Create dictionary with each QID : Var_Name (where the var name is the Question_Export_Tag) 
#Will use this to use for renaming the data dictionary var names later
api_q_dict = {}
for i in df.columns:
